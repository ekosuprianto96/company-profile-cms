<form class="forms-sample" action="" method="POST">
    ...
    <div class="form-group">
      ...
      <input name="nama" type="text" class="form-control" id="nama" placeholder="Nama group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" name="deskripsi" id="deskripsi" style="height: 120px" placeholder="Keterangan group"></textarea>
