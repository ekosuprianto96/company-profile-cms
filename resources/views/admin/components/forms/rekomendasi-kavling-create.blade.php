...
<form action="{{ route('admin.rekomendasi_kavling.store') }}" method="POST" enctype="multipart/form-data" class="">
    @csrf
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4>Tambah Rekomendasi Kavling</h4>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="title">Title</label>
                                <input required name="title" type="text" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Title">                            
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <div class="row" id="wrapper_images">
                                    {{-- <div class="col-md-3 mb-3">
                                        <div class="w-full border" style="height: 150px">
