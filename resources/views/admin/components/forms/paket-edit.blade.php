...
<form action="{{ route('admin.packages.update', $package['id']) }}" method="POST">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Form Edit Paket</h4>
                    <div class="row">
                        <div class="col-md-6 mb-3 mb-lg-0">
                            <div class="form-group">
                                <label for="name">Nama Paket</label>
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $package['name'] }}" id="name" placeholder="Nama Paket">
                                @error('name')
                        ...
                        <div class="col-md-6 mb-3 mb-lg-0">
                            <div class="form-group">
                                ...
                                <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" value="{{ $package['description'] }}" id="description" placeholder="Masukkan deskripsi singkat paket ini...">
                                @error('description')
                                    <div class="invalid-feedback">
                                        <span class="text-danger">{{ $message }}</span>
                                    </div>
                        ...
                        <div class="col-md-12 mb-3 mb-lg-0">
                            <div class="form-group">
                                ...
                                <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ $package['price'] }}" id="price" placeholder="Harga Paket cth: 10000...">
                                @error('price')
                                    <div class="invalid-feedback">
                                        <span class="text-danger">{{ $message }}</span>
                                    </div>
                        ...
                        <div class="col-md-6 mb-3 mb-lg-0">
                            <div class="form-group">
                                ...
                                <select name="show_price" class="form-control" id="show_price">
                                    <option @selected((bool) !$package['show_price']) value="0">Tidak</option>
                                    <option @selected((bool) $package['show_price']) value="1">Ya</option>
                                </select>
                                @error('show_price')
                                    <div class="invalid-feedback">
                                        <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-6 mb-3 mb-lg-0">
                            <div class="form-group">
                                ...
                                <select name="is_recommended" class="form-control" id="is_recommended">
                                    <option @selected((bool) !$package['is_recommended']) value="0">Tidak</option>
                                    <option @selected((bool) $package['is_recommended']) value="1">Ya</option>
                                </select>
                                ...
                                <ul class="list_feature m-0 p-0" style="list-style: none">
                                    ...
                                    @else
                                        @foreach ($package['features'] as $key => $feature)
                                            <li class="p-3 border mb-2 item_feature" data-id="{{ $key }}">
                                                <div class="row">
                                                    <div class="col-md-11">
                                                        <div class="d-flex align-items-center h-100">
                                                            <input type="hidden" name="features[]" value="{{ $feature }}">
                                                            <i class="ri-draggable"></i> {{ $feature }}
                                                        </div>
                                                    </div>    
                                                    <div class="col-md-1 text-end">
                                                        <a href="javascript:void(0)" data-id="{{ $key }}" class="btn btn-danger delete_feature btn-sm"><i class="ri-close-line"></i></a>
                                                    </div>    
                                                </div>
                                            </li>
                                        @endforeach
