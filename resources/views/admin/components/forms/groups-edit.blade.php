<form class="forms-sample" action="" method="POST">
    ...
    <div class="form-group">
      ...
      <input name="nama" value="{{ $group->nama }}" type="text" class="form-control" id="nama" placeholder="Nama group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" name="deskripsi" id="deskripsi" style="height: 120px" placeholder="Keterangan group">{{ $group->deskripsi }}</textarea>
...
<script>
    $(document).ready(function() {
        ...
        $('#buttonUpdate').click(function() {
            $.post('{{ route('admin.groups.update', $group->id_group) }}', {
                nama: $('[name=nama]').val(),
