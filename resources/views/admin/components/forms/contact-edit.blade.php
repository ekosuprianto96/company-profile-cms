    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input name="name" type="text" class="form-control" value="{{ $contact->name }}" id="name" placeholder="Nama...">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input name="email" type="text" class="form-control" value="{{ $contact->email }}" id="email" placeholder="Email...">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input name="phone" type="text" class="form-control" value="{{ $contact->phone }}" id="phone" placeholder="Phone...">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea name="address" id="address" class="form-control" style="height: 100px">{{ $contact->address }}</textarea>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#buttonUpdate').click(function() {
            $.post('{{ route('admin.email.contact.update') }}', {
                name: $('[name=name]').val(),
