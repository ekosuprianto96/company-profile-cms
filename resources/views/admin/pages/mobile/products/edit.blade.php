...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                @include('admin.components.forms.partials.product-fields', ['product' => $product, 'categories' => $categories, 'services' => $services, 'categoryTree' => $categoryTree, 'suppliers' => $suppliers, 'formId' => 'productForm'])
