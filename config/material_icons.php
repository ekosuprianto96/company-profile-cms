...
// AUTO-GENERATED from @expo/vector-icons MaterialIcons.glyphMap (2234 ikon).
// Ini nama EXACT yang bisa dirender aplikasi mobile (key kebab-case MaterialIcons).
// Picker ikon admin memakai daftar ini sebagai master. Regenerate bila Expo di-upgrade.

return [
    // Ikon yang sering dipakai — tampil lebih dulu di picker.
    'popular' => [
        'home',
        'home-repair-service',
        'handyman',
    ...
    // Seluruh ikon MaterialIcons yang valid.
    'icons' => [
        '10k',
        '10mp',
        '11mp',
